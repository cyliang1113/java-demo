...
public class Demo01 {
	public static void main(String[] args) {
		...
		proxy.say();
		Person proxy1 = (Person) Proxy.newProxyInstance(Demo01.class.getClassLoader(), new Class[]{Person.class}, new ManHandler(new Man()));
		proxy1.say();
	}
	...
	private static class ManHandler implements InvocationHandler{
